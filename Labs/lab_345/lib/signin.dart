  ...
  Widget _buildSignInButton(BuildContext context) {
    return ElevatedButton(
      onPressed: () async {
        ...
        final signInResult = await authService.signInWithEmailAndPassword(email, password);
  ...
  Widget _buildSignUpButton(BuildContext context) {
    return ElevatedButton(
      onPressed: () async {
        ...
        final password = userPasswordController.text.trim();
        final authService = Provider.of<AuthService>(context, listen: false);
        final signUpResult = await authService.signUpWithEmailAndPassword(email, password);
